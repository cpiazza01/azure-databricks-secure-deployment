...
#   depends_on = [databricks_schema.cdp_analytics_team_work_schemas]
# }
...
#   principal  = each.value.ro_sp_application_id
#   privileges = var.cdp_ro_privileges_team_schemas
#   depends_on = [databricks_schema.cdp_analytics_team_curated_schemas]
# }
...
# resource "databricks_schema" "cdp_application_team_schemas" {
...
#   principal  = each.value.ro_sp_application_id
#   privileges = var.cdp_ro_privileges_team_schemas
#   depends_on = [databricks_schema.cdp_application_team_schemas]
# }
